...
export type AdminCatalogueItem = { id: number; category: 'medication' | 'route' | 'frequency' | 'duration' | 'laterality' | 'procedure'; code: string; displayName: string; active: boolean; displayOrder: number; version: number }
